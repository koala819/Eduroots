  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-primary/10
          rounded-full blur-3xl animate-pulse" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary/10
      ...
      <main className="w-full max-w-4xl mx-auto relative z-10">
        <div className="backdrop-blur-xl bg-background/80 border border-border/30 rounded-3xl
          shadow-2xl p-6 lg:p-10 space-y-8">


          {/* Header */}
          <div className="text-center space-y-4">
            <div className="w-full h-32 mx-auto bg-gradient-to-br from-primary to-primary-light
            ...
            <div className="space-y-2">
              <h1 className="text-4xl font-bold bg-gradient-to-r from-primary to-primary-light
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-secondary/5 border border-accent rounded-lg p-4">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-foreground">4.1. Familles</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium text-foreground">4.2. Enseignants</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium text-foreground">4.3. Administration</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-foreground">7.1. Droit d'accès</h3>
                  <p className="text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium text-foreground">7.3. Droit à l'effacement</h3>
                  <p className="text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium text-foreground">7.5. Droit d'opposition</h3>
                  <p className="text-muted-foreground">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-foreground">8.1. Espace Familles</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium text-foreground">8.2. Espace Enseignants</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                En utilisant cette application, vous confirmez :
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
