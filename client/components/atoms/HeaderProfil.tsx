...
export const HeaderProfil = ({
  ...
  const defaultTimeSlot = classroomTimeSlots && classroomTimeSlots.length > 0
    ? classroomTimeSlots[0].id
    : ''
                ...
                <div className="flex flex-col min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium truncate">
                      {selectedTimeSlot
                        ? formatDayOfWeek(
                            classroomTimeSlots.find((ts) => ts.id === selectedTimeSlot)
