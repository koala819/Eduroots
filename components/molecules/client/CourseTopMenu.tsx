// components/molecules/client/CourseTopMenu.tsx
'use client'
...
import { CourseSelector } from '@/components/atoms/client/CourseSelector'
...
export const TopMenu = ({
  ...
  selectedSession: any // À typer correctement selon votre structure
}) => {
