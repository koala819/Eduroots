    ...
    switch (deviceInfo.os) {
      case 'windows':
        return (
          ...
          >
            <path
              d="M5 4C4.448 4 4 4.447 4 5L4 24 24 24 24 4 5 4zM26 4L26 24 46 24 46 5C46 4.447 45.552 4 45 4L26 4zM4 26L4 45C4 45.553 4.448 46 5 46L24 46 24 26 4 26zM26 26L26 46 45 46C45.552 46 46 45.553 46 45L46 26 26 26z"
              fill="currentColor"
            />
          </svg>
        )
      ...
      case 'android':
        return (
          ...
          >
            <path
              d="M8.33 31.25C6.6 31.25 5.2 29.85 5.2 28.13V17.71C5.2 15.98 6.6 14.58 8.33 14.58C10.06 14.58 11.46 15.98 11.46 17.71V28.13C11.46 29.85 10.06 31.25 8.33 31.25ZM41.67 31.25C39.94 31.25 38.54 29.85 38.54 28.13V17.71C38.54 15.98 39.94 14.58 41.67 14.58C43.4 14.58 44.8 15.98 44.8 17.71V28.13C44.8 29.85 43.4 31.25 41.67 31.25ZM37.5 11.46L40.63 6.25C40.83 5.94 40.73 5.52 40.42 5.31C40.1 5.1 39.69 5.21 39.48 5.52L36.25 10.83C33.85 9.69 31.15 9.06 28.33 9.06C25.52 9.06 22.81 9.69 20.42 10.83L17.19 5.52C16.98 5.21 16.56 5.1 16.25 5.31C15.94 5.52 15.83 5.94 16.04 6.25L19.17 11.46C14.48 14.17 11.46 19.06 11.46 24.69H45.21C45.21 19.06 42.19 14.17 37.5 11.46ZM20.83 19.27C19.9 19.27 19.17 18.54 19.17 17.61C19.17 16.67 19.9 15.94 20.83 15.94C21.77 15.94 22.5 16.67 22.5 17.61C22.5 18.54 21.77 19.27 20.83 19.27ZM35.83 19.27C34.9 19.27 34.17 18.54 34.17 17.61C34.17 16.67 34.9 15.94 35.83 15.94C36.77 15.94 37.5 16.67 37.5 17.61C37.5 18.54 36.77 19.27 35.83 19.27ZM11.46 26.35C11.46 33.85 17.5 39.9 25 39.9C32.5 39.9 38.54 33.85 38.54 26.35H11.46Z"
              fill="currentColor"
            />
          </svg>
        )
            ...
            return (
              <Accordion type="single" collapsible key={log._id}>
                <AccordionItem value={log._id}>
                  <AccordionTrigger
                    className={`${log.isSuccessful ? 'bg-white hover:bg-gray-50' : 'bg-red-100 hover:bg-red-200'} p-4 rounded-lg transition-colors duration-150 ease-in-out`}
                  >
                      ...
                      <div className="flex items-center space-x-4">
                        <span className="text-sm font-medium text-gray-900">
                          {log.user.firstname && log.user.lastname
                            ? `${log.user.firstname.charAt(0).toUpperCase() + log.user.firstname.slice(1).toLowerCase()} ${log.user.lastname.toUpperCase()}`
                            : log.user.email}
                        </span>
