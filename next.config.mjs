...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_ONESIGNAL_APP_ID_MERE: process.env.ONESIGNAL_APP_ID_MERE,
    NEXT_PUBLIC_ONESIGNAL_APP_ID_COLOMIERS:
      process.env.ONESIGNAL_APP_ID_COLOMIERS,
    ONESIGN_REST_API_KEY: process.env.ONESIGN_REST_API_KEY,
